...
public class MenuController(IMenuService menuService) : ControllerBase {
    ...
    public Task<ResponseResult<List<MenuVO>>> SearchMenu([FromRoute] int typeId, [FromQuery] string username, [FromQuery] int? status) {
    ...
    public Task<ResponseResult<List<RoleVO>>> SelectAll() {
        throw new NotImplementedException();
    }
    ...
    public Task<ResponseResult<object>> Add([FromBody] [Required] MenuDTO menuDTO) {
        throw new NotImplementedException();
    }
    ...
    public Task<ResponseResult<MenuByIdVO>> GetById([FromRoute] [Required] long id) {
        throw new NotImplementedException();
    }
